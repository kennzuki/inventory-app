...
import { ArrowLeft, Sparkles, Save, X, Package, DollarSign, Truck } from "lucide-react";
...
export default function NewProductPage() {
  ...
  // Start empty on the server; fill in on the client in useEffect below.
  // This avoids a hydration mismatch (Math.random() differs between
  // server-render and client-render).
      ...
      <form onSubmit={handleSubmit} className="max-w-4xl space-y-6">
        ...
        <div className="flex items-center justify-end gap-3 pt-2">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 px-6 py-2.5 text-xs font-bold text-white bg-[#0F3D3E] hover:bg-[#2E7D75] disabled:opacity-60 disabled:cursor-not-allowed rounded-lg shadow-xs transition-colors"
          >
            <Save size={16} />
